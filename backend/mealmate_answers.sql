...
CREATE TABLE `answers` (
  ...
  KEY `saq_answer_id_idx` (`saq_answer_id_fk`),
  CONSTRAINT `saq_answer_id` FOREIGN KEY (`saq_answer_id_fk`) REFERENCES `survey_answer_question` (`survey_answer_question_id`)
